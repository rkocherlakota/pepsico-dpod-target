...
class OCRProcessor:
    ...
    def extract_invoice_fields(self, full_text: str, signature_flag : bool) -> InvoiceFields:
    ...
    def _convert_date_format(self, date_str: str) -> str:
        ...
        # Handle DD.MMM.YYYY format (e.g., "07.Jul.2025")
        ...
        # Handle MMM DD, YYYY format (e.g., "Jul 07, 2025")
    ...
    def process_images(self, image_paths: list, filename: str, sticker_flag: bool, signature_flag:bool) -> OCRResult:
        ...
        for page_num, image_path in enumerate(image_paths):
            try:
                ...
                page_fields = self.extract_invoice_fields(full_text, signature_flag)
